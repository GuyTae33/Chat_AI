...
관련 있는 예시: 치수 문의, 색상 선택, 가격 질문, 설치 지역, 옵션 질문, 인사말, 감사 인사, 네/아니오 답변, 숫자만 입력, 이미지·3D 도면·사진 요청, 이미지 재전송 요청, 이미지가 안 보이거나 사라짐, 앱·채팅 이용 중 불편 사항, 레이아웃·형태 선택(일자형, ㄱ자형, ㄷ자형, 11자형, ㄴ자형 등 형태 이름 단독 입력).
고객 상황 설명도 YES: "집에 없어", "일주일 있어/없어", "지금 밖이야", "사진 못찍어", "바빠서요", "나중에 볼게요", "잠깐만요", "생각해볼게요", "비싸네요", "이사해요", "새집이에요", "남편한테 물어볼게요", 날짜·일정·시간 관련 말, 짧은 감탄사(헐, 오, ㅋㅋ 등), 상담 중 나오는 모든 짧은 반응.
신체·측정 관련도 YES: 손이 작아/커, 발이 작아/커, 뼘이 짧아/길어, 걸음이 좁아/넓어, 키가 작아/커, 평균보다 손/발/뼘/걸음이 크다/작다 — AI가 뼘·걸음으로 방 크기를 물어볼 때 고객의 자연스러운 답변.
짧은 단답도 반드시 YES: "없어요", "있어요", "몰라요", "모르겠어요", "괜찮아요", "알겠어요", "됐어요", "맞아요", "아니요", "네", "응", "어" — AI가 무언가를 물어본 뒤 고객이 짧게 답하는 말은 무조건 YES.
이전 AI 발화 참조도 YES: "물어봤잖아", "아까 말했잖아", "방금 그거요", "이미 말했어", "개인정보 물어봤잖아", "이름 물어봤잖아", "아까 질문하셨잖아요" — AI가 먼저 요청한 내용을 고객이 언급하는 말은 모두 YES.
개인정보·프라이버시 관련 발언도 반드시 YES: "개인정보 주기 싫어", "내 개인정보를 누구한테 주기 좀 그래서", "왜 이름이 필요해요", "정보 안 줘도 되나요", "내 정보 어디 쓰는 거예요" — 상담 중 이름·연락처를 요청받은 고객의 자연스러운 반응이므로 항상 YES.
관련 없는 예시: 정치, 연예인, 음식 레시피, 게임, 욕설, 날씨, 코딩 질문, 타 브랜드 비교.`,
